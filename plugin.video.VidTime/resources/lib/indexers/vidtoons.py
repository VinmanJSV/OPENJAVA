...
def VidToon():
    addDirectoryItem('Cartoon Craze','VCartoonCraze', '0', mediaPath+'VidToonsLogo.png', mediaPath+'VidToons.png')
    addDirectoryItem('Anime','VAnime', '0', mediaPath+'AnimeLogo.png', mediaPath+'Anime.png')
    endCategory()
...
def VAalpha(image,fanart):
    try:    
        ...
        for item in list:
            ...
            addDirectoryItem(item[0], 'VAcat', image, image, fanart, url)
        endDirectory()
    except:
        pass
...
def VAcat(url, image, fanart):
    ...
    for item in items:
        try:
            ...
            image = thumb+cookie
            addDirectoryItem(name, 'VApart', image, image, fanart, url)
        except:
            pass
...
def VApart(url, image, fanart):
    ...
    for item in items[::-1]:
        try:
            ...
            addDirectoryItem(name,'VAstream',image,image,fanart,url)
        except:
            pass
...
def VCalpha(image,fanart):
    try:    
        ...
        for item in list:
            ...
            addDirectoryItem(item[0], 'VCcat', image, image, fanart, url)
        endDirectory()
    except:
        pass
...
def VCpart(url, image, fanart):
    ...
    for item in items[::-1]:
        try:
            ...
            addDirectoryItem(name,'VCstream',image,image,fanart,url)
        except:
            pass
